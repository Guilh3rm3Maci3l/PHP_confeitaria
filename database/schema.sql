...
CREATE TABLE insumos (
    ...
    descricao TEXT,
    unidade_medida ENUM('kg', 'g', 'L', 'ml', 'un', 'cx', 'pct') NOT NULL,
...
INSERT INTO insumos (nome, descricao, unidade_medida, estoque_atual, estoque_minimo, custo_unitario_atual, categoria, fornecedor) VALUES
('Açúcar', 'Açúcar refinado para confeitaria', 'kg', 50.000, 10.000, 4.50, 'Ingredientes Básicos', 'Distribuidora ABC'),
('Farinha de Trigo', 'Farinha de trigo especial para bolos', 'kg', 25.000, 5.000, 3.80, 'Ingredientes Básicos', 'Moinho XYZ'),
('Ovos', 'Ovos frescos tipo A', 'un', 100.000, 20.000, 0.35, 'Ingredientes Básicos', 'Granja São José'),
('Manteiga', 'Manteiga sem sal', 'kg', 8.000, 2.000, 12.50, 'Laticínios', 'Laticínio Central'),
('Chocolate em Pó', 'Cacau em pó 100%', 'kg', 5.000, 1.000, 18.90, 'Chocolates', 'Cacau Brasil'),
('Fermento', 'Fermento químico', 'kg', 2.000, 0.500, 8.90, 'Ingredientes Básicos', 'Distribuidora ABC'),
('Leite', 'Leite integral', 'L', 20.000, 5.000, 3.20, 'Laticínios', 'Laticínio Central'),
('Baunilha', 'Essência de baunilha', 'ml', 500.000, 50.000, 0.15, 'Aromatizantes', 'Distribuidora ABC');
...
INSERT INTO receita_ingredientes (receita_id, insumo_id, quantidade, unidade_medida, ordem) VALUES
-- Bolo de Chocolate
